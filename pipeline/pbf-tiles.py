...
Kyiv: 3 x 3 road tiles plus the tram network (including the two Shvydkisnyi
Tramvai light-rail lines).
"""
...
S, N, W, E = 50.19, 50.61, 30.24, 30.82
RAIL_BOX = (50.2, 30.25, 50.6, 30.81)
...
rail_file = os.path.join(ROOT, 'data/osm/kyiv-rail.json')
